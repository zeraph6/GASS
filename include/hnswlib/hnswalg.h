...
//        static const unsigned char REUSE_MARK = 0x10;
        ...
        void addPoint(const void *data_point, labeltype label, int rng, float prune, int cnt) {
            addPoint(data_point, label,-1, rng, prune, cnt);
        }
...
//                        continue;
        ...
        tableint addPoint(const void *data_point, labeltype label, int level, int rng, float prune, int cnt) {
...
//                    printf(" cur %i ,cands %i\n",cur_element_count, top_candidates.size());
        ...
        float * searchGraph(const void *query_data, size_t k, querying_stats & stats) const {
...
//                        __COUNT_NUM_DISTCAL
        ...
        float * searchGraphBsl(const void *query_data, size_t k, querying_stats & stats) const {
